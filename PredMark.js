...
async function insertDataIntoTable(dataone, datatwo, TeamID) {
    ...
    tr.innerHTML = `<tr>
        ...
        <td>Your Short Interest: ${UserFadeDeposit} $XDAI<br> <input type="number" id="ShortInput${TeamID}" placeholder="Enter Amount"></input><br><button onclick="IncreaseInterest(false, ${TeamID})">Increase Short Interest</button></td>
        </tr>
    `;

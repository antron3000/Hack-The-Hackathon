...
function insertDataIntoTable(dataone, datatwo, TeamID) {
    ...
    const UserForDeposit = PredictionsContract.UserForDeposits(signer.address, TeamID)
    const UserFadeDeposit = PredictionsContract.UserFadeDeposits(signer.address, TeamID)

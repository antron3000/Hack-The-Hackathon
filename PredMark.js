...
async function insertDataIntoTable(dataone, datatwo, TeamID) {
    ...
    tr.innerHTML = `<tr>
        ...
        <td>Your Long Interest: ${UserForDeposit} $XDAI<br> <input id="LongInput${TeamID}" placeholder="Increase Long Interest"></input></a></td>
        <td>Your Short Interest: ${UserFadeDeposit} $XDAI<br> <input id="LongInput${TeamID}" placeholder="Increase Short Interest"></input></td>
        </tr>
    `;
